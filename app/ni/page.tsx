...
export default function NIPortalPage() {
  return (
    <section className="min-h-screen bg-[#5a5200] text-white relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(245,208,0,0.22),transparent_35%),radial-gradient(circle_at_bottom_right,rgba(217,184,0,0.18),transparent_30%),linear-gradient(180deg,#3d3400_0%,#5a5200_100%)]" />
        ...
        <div className="w-full max-w-4xl rounded-[2rem] border border-white/10 bg-white/10 backdrop-blur-xl overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.28)]">
          <div className="p-8 sm:p-12">
            <div className="inline-flex items-center gap-2 bg-white rounded-[1.5rem] px-6 py-4 shadow-[0_20px_60px_rgba(0,0,0,0.2)] mb-10">
              ...
              <span className="text-lg font-extrabold tracking-tight text-[#D9B800]">Networks</span>
            </div>

            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 rounded-full border border-yellow-200/20 bg-yellow-300/10 px-4 py-2 text-[11px] font-black tracking-[0.25em] uppercase text-yellow-100 mb-6">
                Dedikált partnerportál
              </div>
              <h1 className="font-serif text-4xl sm:text-5xl font-bold tracking-tight mb-4">
                NI vállalati hozzáférés
              </h1>
              <p className="text-lg text-yellow-50/90 leading-relaxed mb-8">
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/admin"
                  className="h-12 px-6 rounded-2xl bg-white text-[#5a5200] text-sm font-black tracking-widest uppercase inline-flex items-center justify-center"
                >
                  Vissza az adminhoz
                </Link>
                <Link

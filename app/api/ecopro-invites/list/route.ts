...
import { listEcoproPortalUsers, type EcoproPortalUser } from "@/lib/ecopro-portal-users";
...
export async function GET() {
  try {
    ...
    const users = await listEcoproPortalUsers();
    const serializable = users.map((u: EcoproPortalUser) => ({

...
import { listEccoinoPortalUsers, type EccoinoPortalUser } from "@/lib/eccoino-portal-users";
...
export async function GET() {
  try {
    ...
    const users = await listEccoinoPortalUsers();
    const serializable = users.map((u: EccoinoPortalUser) => ({

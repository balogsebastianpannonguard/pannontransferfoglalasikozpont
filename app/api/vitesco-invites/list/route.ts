...
import { listVitescoPortalUsers, type VitescoPortalUser } from "@/lib/vitesco-portal-users";
...
export async function GET() {
  try {
    ...
    const users = await listVitescoPortalUsers();
    const serializable = users.map((u: VitescoPortalUser) => ({

...
export default function EcoproLoginClient() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const response = await fetch("/api/ecopro-auth/login", {
        method: "POST",
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
        <div className="w-full max-w-[560px]">
          <div className="mb-8 text-center">
            ...
            <p className="text-sm text-sky-100/90 font-medium">Bejelentkezés az EcoPro dedikált partnerportálra.</p>
          </div>
          ...
          <div ref={resultRef} className="rounded-[2rem] border border-white/10 bg-white/95 text-admin-gray-900 shadow-[0_30px_80px_rgba(0,0,0,0.25)] overflow-hidden">
            <div className="h-1.5 bg-[linear-gradient(90deg,#0096D6_0%,#F28C28_60%,#0096D6_100%)]" />
            <div className="p-8 sm:p-10">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  style={{ background: "linear-gradient(90deg, #0096D6 0%, #F28C28 60%, #0096D6 100%)" }}
                >

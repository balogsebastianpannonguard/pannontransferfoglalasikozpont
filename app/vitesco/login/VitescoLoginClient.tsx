...
export default function VitescoLoginClient() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const response = await fetch("/api/vitesco-auth/login", {
        method: "POST",
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
        <div className="w-full max-w-[560px]">
          <div className="mb-8 text-center">
            ...
            <p className="text-sm text-red-100/90 font-medium">Bejelentkezés a Vitesco dedikált partnerportálra.</p>
          </div>
            ...
            <div className="p-8 sm:p-10">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  style={{ background: "linear-gradient(90deg, #E30613 0%, #B80010 60%, #E30613 100%)" }}
                >

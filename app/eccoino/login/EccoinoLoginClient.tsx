...
export default function EccoinoLoginClient() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const response = await fetch("/api/eccoino-auth/login", {
        method: "POST",
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
        <div className="w-full max-w-[560px]">
          <div className="mb-8 text-center">
            ...
            <p className="text-sm text-sky-100/90 font-medium">Bejelentkezés az Eccoino dedikált partnerportálra.</p>
          </div>

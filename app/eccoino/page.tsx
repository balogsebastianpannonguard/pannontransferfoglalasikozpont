...
export const metadata = {
  title: "Eccoino Transfer | Pannon Transfer",
  description: "Eccoino Transfer dedikált partnerportál.",
};

export default function EccoinoPortalPage() {
  return (
          ...
          <div className="p-8 sm:p-12">
            ...
            <div className="max-w-2xl">
              ...
              <h1 className="font-serif text-4xl sm:text-5xl font-bold tracking-tight mb-4">
                Eccoino vállalati hozzáférés
              </h1>
              <p className="text-lg text-sky-50/90 leading-relaxed mb-8">
                Az Eccoino Transfer külön portálja és meghívási folyamata. A vizuális portáloldal elkészült, az aktiválási link ide tér vissza.
              </p>

              <div className="flex flex-wrap gap-4">
                <Link
                  href="/admin"
                  className="h-12 px-6 rounded-2xl bg-white text-[#0a1929] text-sm font-black tracking-widest uppercase inline-flex items-center justify-center"
                >
                  Vissza az adminhoz
                </Link>
                <Link

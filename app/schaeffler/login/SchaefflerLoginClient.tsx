...
export default function SchaefflerLoginClient() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const response = await fetch("/api/schaeffler-auth/login", {
        method: "POST",
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
        <div className="w-full max-w-[560px]">
          <div className="mb-8 text-center">
            ...
            <p className="text-sm text-emerald-100/90 font-medium">Bejelentkezés a Schaeffler dedikált partnerportálra.</p>
          </div>
